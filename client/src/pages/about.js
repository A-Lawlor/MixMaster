  ...
  return (
    <Container>
      ...
      <Row className="justify-content-center align-items-center" style={{ marginTop: "2vh", marginBottom: "5vh"}}>
        <Col id="anthony_profile" className= "text-center" xs={12} md={3}>
        ...
        <Col id="dalton_profile" className= "text-center" xs={12} md={3}>
        ...
        <Col id="daury_profile" className= "text-center" xs={12} md={3}>
        ...
        <Col id="matt_profile" className= "text-center" xs={12} md={3}>
